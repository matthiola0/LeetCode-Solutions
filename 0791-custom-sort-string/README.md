<h2><a href="https://leetcode.com/problems/custom-sort-string/?envType=problem-list-v2&envId=w5wjopji">791. Custom Sort String</a></h2><h3>Medium</h3><hr><p>You are given two strings <code>order</code> and <code>s</code>. All the characters of <code>order</code> are <strong>unique</strong> and were sorted in some custom order previously.</p>
